...
```console
docker build --build-arg build_image=rust:1.67-buster --build-arg base_image=debian:buster --build-arg frontend_build_image=node:16-slim -f examples/some-issuer/scripts/build.Dockerfile .
```

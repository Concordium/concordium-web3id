  ...
  return (
    <Toast {...props}>
      <Toast.Header>
        <img
          src={ccdLogo}
          className="status-toast__icon me-2"
          alt="Concordium logo"
        />
      ...
      <Toast.Body className="text-start">
        <p
          className={clsx(
            'mb-0',
            transactionStatus !== 'submitted' && 'text-muted',
          )}
        >
        ...
        {transactionStatus === 'submitted' && (
          <p className="mb-0">
            Awaiting finalization: {'.'.repeat(secondsWaited)}
          </p>
        )}
        {transactionStatus === 'finalized' && (
          <p className="mb-0">Transaction finalized</p>
        )}
      </Toast.Body>
    </Toast>
  );

...
export const CONCORDIUM_TESTNET_VERIFIER_V0 = 'https://web3id-verifier.testnet.concordium.com';
export const CONCORDIUM_TESTNET_VERIFIER_V1 = 'https://credential-verification-service.testnet.concordium.com';
